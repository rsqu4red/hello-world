# Entwurf: Begründung zur Bauvoranfrage / Antrag auf Befreiung

> **Arbeitsentwurf** — vor Versand: Absender, Datum, Aktenzeichen ergänzen; Zahlen (Grundstücksgröße,
> Abstände) nach Vermessung präzisieren; ggf. anwaltlich/architektonisch gegenzeichnen lassen.

---

**An die Gemeinde Bammental — Bauamt —**
zugleich zur Vorlage bei der unteren Baurechtsbehörde

**Betreff: Bauvoranfrage — Neubau eines Wochenendhauses auf Flst. 7348, Gemarkung Bammental,
Bebauungsplan „Wochenendhausgebiet – 1. Änderung (Neufassung)";
Antrag auf Befreiung von der festgesetzten Baugrenze (§ 31 Abs. 2 BauGB) und auf Ausnahme vom
Waldabstand (§ 4 Abs. 3 LBO BW)**
...
- Wochenendhaus mit **max. 65 m² Grundfläche** — exakt das Maß, das der Bebauungsplan für alle
...
Beantragt wird allein die **Überschreitung der eng gefassten Baugrenze (Baufenster Nr. 9)**; alle
übrigen Festsetzungen werden eingehalten.
...
Forstverwaltung, es bestehe „keine Aussicht", dass „im Rahmen von Einzelgenehmigungsverfahren …
Ausnahmen" zugelassen würden. Zugleich hält die Begründung fest, dass das vorhandene Gebäude
„**zulässigerweise** innerhalb des … Waldabstandsstreifens von 30 m errichtet worden" ist und die
Gemeinde das Grundstück gerade **bebaubar halten wollte**.

## 3. Die Rechtslage hat sich geändert

Die der Planung von 2008 zugrunde liegende Annahme ist überholt. § 4 Abs. 3 LBO BW in der seit
28.06.2025 geltenden Fassung (LBO-Reform 2025) bestimmt:

- Der 30-m-Abstand **gilt nicht** für Gebäude, die nach den **Festsetzungen eines Bebauungsplans**
  mit geringerem Abstand zulässig sind, und nicht für **bauliche Änderungen rechtmäßig
  bestehender Anlagen**;
- im Übrigen **können Ausnahmen zugelassen werden** — ohne die engen Voraussetzungen des
  früheren Rechts.

Der Gesetzgeber hat damit klargestellt, dass der Waldabstand kein starres Bauverbot ist. Die
pauschale Absage von 2008 entspricht nicht mehr dem geltenden Recht und kann die Beschränkung
meines Grundstücks nicht mehr tragen.

## 4. Gründe für Befreiung und Ausnahme

**a) Die Grundzüge der Planung werden nicht berührt.** Beantragt wird ausschließlich dasjenige
Nutzungsmaß, das der Plan jedem anderen Grundstück im Gebiet zubilligt. Art der Nutzung,
Gebäudetyp, Höhe, Dachform und der lockere Gebietscharakter bleiben unverändert. Die Gemeinde
wollte Flst. 7348 ausweislich der Planbegründung bebaubar halten; die Befreiung verwirklicht
diese Planungsabsicht.

**b) Städtebauliche Vertretbarkeit.** Der Neubau entspricht in Körnung, Höhe und Gestaltung exakt
der zulässigen Nachbarbebauung; zusätzliche Erschließung ist nicht erforderlich; die GRZ von 0,15
wird eingehalten.

**c) Offenbar nicht beabsichtigte Härte / Gleichbehandlung.** Ich trage dieselben Erschließungs-
und Folgekosten wie alle Eigentümer im Gebiet, dürfte aber als Einziger nur den Altbestand
erhalten. Die Gemeinde hat bereits 2008 anerkannt, dass geringere Nutzungsmaße „keine zeitgemäße
Nutzung entsprechend der Zweckbestimmung erlauben" und die Kostenbelastung „eine angemessene
Grundstücksausnutzung erlauben muss" (Begründung Kap. 5.2). Diese Wertung beansprucht für mein
...
von den angrenzenden Grundstücken aus als gebietstypisches Wochenendhaus wahrnehmbar.
